...
[출력 규칙]
1. 분량: 최대 3,000자 이내 (A4 용지 2장 분량). 각 항목마다 상세하게 설명하되, 전체 답변이 너무 길어지지 않도록 핵심 위주로 명료하고 밀도 있게 풀이할 것. 짧은 요약은 피하되 분량을 절대 넘기지 마시오.
...
[분석 지침 및 출력 규칙]
1. 분량: 최대 3,000자 이내 (A4 용지 2장 분량). 대운수와 연운을 교차 분석하며 소름 돋을 정도로 구체적인 조언을 담아내되, 전체 글이 지루하게 길어지지 않도록 분량을 서서히 조절할 것.
