...
@router.post("/palmistry", response_model=PhysiognomyResponse)
async def analyze_palm(request: PhysiognomyRequest):
    try:
        ...
        prompt = (
            ...
            "주어진 손바닥 사진을 보고 주요 선(생명선, 두뇌선, 감정선, 운명선 등)의 굵기, 길이, 뻗어나간 모양을 관찰해주세요. "
            "그리고 이를 바탕으로 현대적이고 유쾌하면서도 격려가 되는 손금 풀이를 제공해주세요. "
            "재물운, 건강운, 직업력을 중심으로 3~4문장으로 짧게 요약해서 설명해 주세요. "
            "생명선이나 감정선 등 선의 이름을 언급하며 근거를 조금씩 보태면 좋습니다. "
            "텍스트만 출력하고 마크다운 문법이나 불필요한 인사말은 제외하세요."
        )
